...
class ArticleManager():
	def __init__(self, dimension, n_articles, ArticleGroups, FeatureFunc, argv ):
		...
		self.dimension = dimension# the length of item features
		self.n_articles = n_articles# the number of articles
		self.ArticleGroups = ArticleGroups# the clusters of articles
		self.FeatureFunc = FeatureFunc # the random distributio of item feature generation
		self.argv = argv
